...
public class ShizukuShellLoader {
    ...
    private static void requestForBinder() throws RemoteException {
        ...
        Intent intent = new Intent("com.chumian.shizcm.intent.action.REQUEST_BINDER")
                .setPackage("com.chumian.shizcm")
        ...
        try {
            ...
            Intent activityIntent = Intent.createChooser(
                    new Intent("com.chumian.shizcm.intent.action.REQUEST_BINDER")
