...
public class BinderSender {
    ...
    private static final String PERMISSION_MANAGER = "com.chumian.shizcm.permission.MANAGER";
    private static final String PERMISSION = "com.chumian.shizcm.permission.API_V23";
